...
#Const ASYNCREADANDWRITE = Not CF
  Public Class SerialPort : Implements IDisposable
    Private ReadOnly portName_ As String, baudRate_ As Integer, parity_ As System.IO.Ports.Parity,
    ...
    Public Enum OptionsValue
      ...
      Sync = 1
    End Enum
    Public Sub New(ByVal portName As String, ByVal baudRate As Integer, ByVal parity As System.IO.Ports.Parity,
...
#End If
    ...
    Private Function TryToOpen() As Boolean
      ...
      ' Open the port, etc
      Const GENERIC_READ As Integer = &H80000000, GENERIC_WRITE As Integer = &H40000000,
...
#End If
    ...
    Public Overrides Function ToString() As String
      Return portName_ & "," & baudRate_.ToString(Globalization.CultureInfo.InvariantCulture) & ","c & parity_.ToString.Substring(0, 1) & ","c &
...
#Else
      ...
      Public Overrides Function BeginRead(ByVal buffer() As Byte, ByVal offset As Integer, ByVal count As Integer,
      ...
      Public Overrides Function EndRead(ByVal asyncResult As IAsyncResult) As Integer
        ...
        Return ret
      End Function
      Public Overrides Function BeginWrite(ByVal buffer() As Byte, ByVal offset As Integer, ByVal count As Integer,
                                           ByVal callback As AsyncCallback, ByVal state As Object) As IAsyncResult
      ...
      Private Class AsyncSerialPort
        ...
        Public Function BeginRead(ByVal hCom As IntPtr, ByVal buffer() As Byte, ByVal offset As Integer, ByVal count As Integer) As IAsyncResult
          ...
          count2 = count
          If NativeMethods.ReadFile(hCom, buffer, count2, red, overlapped_) = 0 AndAlso
        ...
        Public Function BeginWrite(ByVal hCom As IntPtr, ByVal buffer() As Byte, ByVal offset As Integer, ByVal count As Integer) As IAsyncResult
          ...
          PinBuffer(buffer)
          If NativeMethods.WriteFile(hCom, buffer, count, 0, overlapped_) = 0 AndAlso
               Runtime.InteropServices.Marshal.GetLastWin32Error <> ERROR_IO_PENDING Then
            UnpinBuffer()
            Return New QuietAsyncResult(Nothing, state_, Date.MinValue)
          End If
...
#Else
      ...
      Public Declare Auto Function CreateFile Lib "kernel32" (
          ...
          ByVal lpSecurityAttributes As IntPtr, ByVal dwCreationDisposition As Integer,
          ByVal dwFlagsAndAttributes As Integer, ByVal hTemplateFile As IntPtr) As IntPtr
...
#End If
  ...
  Public Class NetworkPort : Inherits System.IO.Stream
    ...
    Private Class ConnectThenSend : Implements IAsyncResult
      Private ReadOnly owner_ As NetworkPort, socket_ As Net.Sockets.Socket,
                       buffer_() As Byte, offset_, count_ As Integer,
...
#End If
    ...
    Public Sub Write(ByVal buffer() As Byte, ByVal offset As Integer, ByVal count As Integer)
      ...
      stm_.Write(buffer, offset, count)
    End Sub
    Public Function BeginWrite(ByVal buffer() As Byte, ByVal offset As Integer, ByVal count As Integer,
                               ByVal callback As AsyncCallback, ByVal state As Object) As IAsyncResult
      If logComEvents_ Then AddEvents(ComEvent.EventTypeValue.Tx, buffer, offset, count)
    ...
    Public Function BeginRead(ByVal buffer() As Byte, ByVal offset As Integer, ByVal count As Integer,
                              ByVal callback As AsyncCallback, ByVal state As Object) As IAsyncResult
      latestRx_ = buffer
