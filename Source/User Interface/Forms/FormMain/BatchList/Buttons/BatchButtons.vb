Public Class BatchButtons : Inherits UserControl
  Private controlCode As ControlCode

  Public Event ButtonClick(sender As Object, button As Button)

  Private buttonBatch As New Button With {.Name = "Main", .Text = "Select Batch"}
  ...
  Private buttonGrid As New Button With {.Name = "Grid", .Text = "Batch List"}
  ...
  Private Sub AddControls()
    ...
    AddButtonMain(buttonBatch, My.Resources.Dyelots24x24)
    ...
    With controlCode
      ...
      If .Settings.DisableSelectButton Then buttonBatch.Enabled = False
      If .Settings.DisableRefreshButton Then buttonRefresh.Enabled = False
    End With
